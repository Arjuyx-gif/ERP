      ...
      <div style={{ display: "flex", flexDirection: "column", flex: 1, overflowY: "auto" }}>
        ...
        <div style={{ padding: "24px 32px 16px", background: "#fff", borderBottom: "1px solid #E5E7EB", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
            ...
            <button onClick={() => navigate("/sc-dashboard")} style={{ background: "#3B82F6", color: "#fff", border: "none", padding: "8px 16px", borderRadius: 6, fontSize: 13, fontWeight: 600, display: "flex", alignItems: "center", gap: 8, cursor: "pointer" }}>
