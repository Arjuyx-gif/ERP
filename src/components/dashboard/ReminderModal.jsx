    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", gap: 8, alignItems: "center", marginBottom: 8 }}>
          <span style={{
            background: "#E3F0FB", color: "#1565C0", padding: "3px 10px",
          ...
          <div style={{
            ...
            {modal.details.map((d, i) => (
              <span key={i} style={{ display: "flex", alignItems: "center", gap: 4 }}>
                {d.icon && <DynamicIcon name={d.icon} size={13} color="#555" />}
                <span style={{ color: d.highlight ? "#2979FF" : "#333", fontWeight: d.highlight ? 600 : 400 }}>
                  {d.text}
                </span>
